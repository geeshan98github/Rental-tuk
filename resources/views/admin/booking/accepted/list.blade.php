...
@section('title', 'New Booking List')
    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-chart-area'></i> New Booking List <span class='fw-300'></span>
            </h1>
        ...
        $(function() {
            $(document).ready(function() {
                var table = $('#dt-basic-example').dataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ route('accepted-booking-list') }}", // or '/rooms.list' for testing
                        type: 'GET',
