...
<main id="js-page-content" role="main" class="page-content">
    ...
    <div class="subheader">
        ...
        {{-- <div class="subheader-block d-lg-flex align-items-center d-none">

            @component('common-components.dashboard-widget')
            @slot('title') EXPENSES @endslot
            @slot('price') $47,000 @endslot
            @slot('values') 3,4,3,6,7,3,3,6,2,6,4 @endslot
            @slot('priceClass') fw-500 fs-xl d-block color-primary-500 @endslot
            @slot('sparkColor') #886ab5 @endslot
            @endcomponent

        </div> --}}
        {{-- <div class="subheader-block d-lg-flex align-items-center border-faded border-right-0 border-top-0 border-bottom-0 ml-3 pl-3 d-none">

            @component('common-components.dashboard-widget')
            @slot('title') MY PROFITS @endslot
            @slot('price') $38,500 @endslot
            @slot('values') 1,4,3,6,5,3,9,6,5,9,7 @endslot
            @slot('priceClass') fw-500 fs-xl d-block color-danger-500 @endslot
            @slot('sparkColor') #fe6bb0 @endslot
            @endcomponent
    ...
    <div class="row">
        {{-- <div class="col-lg-12">
            <div id="panel-1" class="panel panel-locked d-none" data-panel-lock="false" data-panel-close="false" data-panel-fullscreen="false" data-panel-collapsed="false" data-panel-color="false" data-panel-locked="false" data-panel-refresh="false" data-panel-reset="false">
        ...
        <div class="col-lg-6">
            {{-- <div id="panel-2" class="panel d-none" data-panel-fullscreen="false">
                <div class="panel-hdr">
                    <h2>
                        Smart Chat
                    </h2>
                            ...
                            <div class="bg-subtlelight-fade custom-scroll" style="height: 244px">
                                <div class="h-100">
                                    ...
                                    <div class="d-flex flex-row px-3 pt-3 pb-2">
                                        <!-- profile photo : lazy loaded -->
                                        <span class="status status-danger">
                                            <span class="profile-image rounded-circle d-inline-block" style="background-image:url('public/back/img/demo/avatars/avatar-admin.png')"></span>
                                        </span>
                                        <!-- profile photo end -->
                                        <div class="ml-3">
        ...
        {{-- <div class="col-lg-6">
            <div id="panel-4" class="panel d-none">
                <div class="panel-hdr">
                    <h2>Bird's Eyes</h2>
                </div>
                <div class="panel-container show">
                    ...
                    <div class="panel-content jqvmap-bg-ocean">
                        <div class="d-flex align-items-center">
                            <img class="d-inline-block js-jqvmap-flag mr-3 border-faded" alt="flag" src="{{ URL::asset('img/svg/us.svg') }}" style="width:25px; height: auto;">
            ...
            <div id="panel-5" class="panel d-none">
                <div class="panel-hdr">
...
<script src="{{ URL::asset('public/back/js/dependency/moment/moment.js') }}"></script>
<script src="{{ URL::asset('public/back/js/miscellaneous/fullcalendar/fullcalendar.bundle.js') }}"></script>
<script src="{{ URL::asset('public/back/js/statistics/sparkline/sparkline.bundle.js') }}"></script>
<script src="{{ URL::asset('public/back/js/statistics/easypiechart/easypiechart.bundle.js') }}"></script>
<script src="{{ URL::asset('public/back/js/statistics/flot/flot.bundle.js') }}"></script>
{{-- <script src="{{ URL::asset('public/back/js/miscellaneous/jqvmap/jqvmap.bundle.js') }}"></script> --}}
...
<script>
    $(document).ready(function()
    {
        ...
        //         $('.js-jqvmap-flag').attr('src', 'https://lipis.github.io/flag-icon-public/back/css/flags/4x3/' + code.toLowerCase() + '.svg');
