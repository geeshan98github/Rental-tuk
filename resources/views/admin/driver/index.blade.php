            ...
            <div class="d-flex justify-content-between align-items-start flex-wrap" style="gap: 16px;">
                <div>
                    <span class="applicant-name-badge">
                        <i class="fal fa-id-badge mr-1"></i>Applicant #{{ $data->id }}
                    </span>
                    <h2><i class="fal fa-user-check mr-2"></i>{{ $data->first_name }} {{ $data->last_name }}</h2>
                ...
                <div class="d-flex align-items-center" style="gap: 10px;">
                    @can('driver-applicant-list')
                        <a href="{{ route('driver-applicant-list') }}" class="btn-back-all">
                ...
                <div class="detail-card animate-in delay-3" id="license-card">
                    <div class="card-header-custom">
                        ...
                        <div>
                            ...
                            <p class="header-subtitle">Driving credentials & skills</p>
                        </div>
                    </div>
                    <div class="card-body p-0">
                        <div class="row m-0">
                ...
                <div class="detail-card animate-in delay-5" id="action-card">
                    ...
                    <div class="card-body" style="padding: 20px 24px;">
                        @can('send-approvel-driver-applicant')
                            <form action="{{ route('send-driver-approvel') }}" method="POST" class="mb-3">
                                @csrf
