    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-chart-area'></i> Instructor List <span class='fw-300'></span>
            </h1>

            <div class="row" style="margin-left:auto; margin-right:auto; gap: 12px">

                @can('approved-instructor-list')
                    <a href=" {{ route('approved-instructor-list') }}">
        ...
        $(function() {
            $(document).ready(function() {
                var table = $('#dt-basic-example').dataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ route('approved-instructor-list') }}", // or '/rooms.list' for testing
                        type: 'GET',
