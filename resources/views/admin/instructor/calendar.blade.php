            ...
            <div class="d-flex justify-content-between align-items-start flex-wrap" style="gap: 16px;">
                <div>
                    <span class="calendar-badge">
                        <i class="fal fa-calendar-alt mr-1"></i>Instructor Settings
                    </span>
                    <h2><i class="fal fa-clock mr-2"></i>Availability Calendar</h2>
                    <p class="header-meta mb-0">
                        <i class="fal fa-info-circle mr-1"></i>Manage instructor availability across the week
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="detail-card animate-in delay-1" id="calendar-form-card">
                    <div class="card-header-custom">
                        ...
                        <div>
                            ...
                            <p class="header-subtitle">Choose the days when the instructor is available for classes</p>
                        </div>
                    </div>
                    
                    <div class="calendar-form-body">
                        <form action="{{ route('save-instructor-availability-calendar') }}" method="POST">
                            @csrf
