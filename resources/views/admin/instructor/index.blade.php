...
@section('headerStyle')
    ...
    <style>
        ...
        .icon-license { background: linear-gradient(135deg, #4facfe, #00f2fe); }
    ...
    <main id="js-page-content" role="main" class="page-content">
            ...
            <div class="d-flex justify-content-between align-items-start flex-wrap" style="gap: 16px;">
                <div>
                    <span class="applicant-name-badge">
                        <i class="fal fa-chalkboard-teacher mr-1"></i>Instructor Applicant #{{ $data->id }}
                    </span>
                    <h2><i class="fal fa-user-graduate mr-2"></i>{{ $data->first_name }} {{ $data->last_name }}</h2>
                ...
                <div class="d-flex align-items-center" style="gap: 10px;">
                    @can('instructor-applicant-list')
                        <a href="{{ route('instructor-applicant-list') }}" class="btn-back-all">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                {{-- License & Experience Card --}}
                <div class="detail-card animate-in delay-3" id="license-card">
                    <div class="card-header-custom">
                        <div class="header-icon icon-license">
                            <i class="fal fa-id-card-alt"></i>
                        </div>
                        <div>
                            <h5>License & Experience</h5>
                            <p class="header-subtitle">Credentials & skills</p>
                        </div>
                    </div>
                    <div class="card-body p-0">
                        <div class="row m-0">
                            <div class="col-md-7 p-0">
                                <div class="detail-row">
                                    <div class="detail-label"><i class="fal fa-id-card"></i> Licence No</div>
                                    <div class="detail-value" style="font-weight: 700; letter-spacing: 1px;">{{ $data->license_number }}</div>
                                </div>
                                <div class="detail-row">
                                    <div class="detail-label"><i class="fal fa-language"></i> Languages</div>
            ...
            <div class="col-lg-4">
                    ...
                    <div class="card-body" style="padding: 20px 24px;">
                        ...
                        <div class="mb-4">
                            <p style="font-weight: 600; color: #64748b; font-size: 0.85rem; margin-bottom: 10px;">
                                <i class="fal fa-id-card mr-1" style="color: #a0aec0;"></i> Driver's License
                            </p>
                            <a href="{{ asset('storage/app/private/' . $data->license_image) }}" target="_blank" class="doc-thumbnail-wrap">
                                <img src="{{ asset('storage/app/private/' . $data->license_image) }}" alt="Driver's License">
                ...
                <div class="detail-card animate-in delay-5" id="action-card">
                    ...
                    <div class="card-body" style="padding: 20px 24px;">
                        @can('send-approvel-instructor-applicant')
                            <form action="{{ route('send-instructor-approvel') }}" method="POST" class="mb-3">
                                @csrf
                        ...
                        @endcan
                        @can('action-instructor-applicant')
                            <form action="{{ route('action-instructor-approvel') }}" method="POST">
                                @csrf
                                <input type="hidden" name="id" value="{{ $data->id }}">
