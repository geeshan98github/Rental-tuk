...
@section('title', 'New Driving Sessions Requests')
    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-chart-area'></i> New Driving Sessions Requests <span class='fw-300'></span>
            </h1>
        ...
        $(function() {
            $(document).ready(function() {
                var table = $('#dt-basic-example').dataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ route('new-driving-session-request-list') }}", // or '/rooms.list' for testing
                        type: 'GET',
