    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-chart-area'></i> {{ __('Create City') }}<span class='fw-300'></span>
            </h1>
                ...
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <form action="{{ route('save-cities') }}" enctype="multipart/form-data" method="post"
                                id="cities-form" class="smart-form row" autocomplete="off" data-parsley-validate>
                                @csrf
                                <div class="mb-3 col-6">
                                    <div class="form-group">
                                        <label class="form-label" for="name">City Name<span
