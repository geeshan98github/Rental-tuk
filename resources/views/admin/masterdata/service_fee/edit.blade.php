    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-chart-area'></i> {{ __('Edit Service Fee') }}<span class='fw-300'></span>
            </h1>

            <div class="row" style="margin-left:auto; margin-right:auto; gap: 12px">
                {{-- <a href=" {{ route('service-fee-create') }}">
                    <button type="button" class="btn btn-lg btn-primary">
                        <span class="mr-1 fal fa-plus"></span>
                        {{ __('Add New') }}
                    </button>
                </a> --}}
                <a href=" {{ route('service-fee-list') }}">
                    <button type="button" class="btn btn-lg btn-primary">
                ...
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <form action="{{ route('update-service-fee') }}" enctype="multipart/form-data" method="post"
                                id="service-fee-form" class="smart-form row" autocomplete="off" data-parsley-validate>
                                @csrf
                                @method('PUT')
                                <div class="mb-3 col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="service" name="service" class="form-control"
                                            data-parsley-required="true" required value="{{ $data->service }}">
                                    </div>
                                </div>
                                <div class="col-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="price" name="price" class="form-control"
                                            data-parsley-required="true" required value="{{ $data->price }}">
                                    </div>
                                </div>
