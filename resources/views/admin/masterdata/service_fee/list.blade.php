...
@section('title', 'Service Fee List')
    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-chart-area'></i>Service Fee List <span class='fw-300'></span>
            </h1>
        ...
        $(function() {
            $(document).ready(function() {
                var table = $('#dt-basic-example').dataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ route('service-fee-list') }}", // or '/user.list' for testing
                        type: 'GET',
