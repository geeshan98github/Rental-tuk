    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-chart-area'></i> {{ __('Edit Vehicle Type') }}<span class='fw-300'></span>
            </h1>
                ...
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <form action="{{ route('update-vehicle-type') }}" enctype="multipart/form-data" method="post"
                                ...
                                <div class="col-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="rate_per_day" name="rate_per_day" class="form-control"
                                            data-parsley-required="true" required value="{{ $data->rate_per_day }}">
                                    </div>
                                </div>
                                <div class="col-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="deposit_price" name="deposit_price" class="form-control"
                                            data-parsley-required="true" required value="{{ $data->deposit_price }}">
                                    </div>
                                </div>
                                <div class="col-6 mb-3">
                                    <div class="form-group">
