    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-chart-area'></i>Vehicle Type List <span class='fw-300'></span>
            </h1>
                            ...
                            <table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ __('Rate per Day') }}</th>
                                        <th>{{ __('Deposit Price') }}</th>
        ...
        $(function() {
            $(document).ready(function() {
                var table = $('#dt-basic-example').dataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ route('vehicle-type-list') }}", // or '/user.list' for testing
                        type: 'GET',
                    ...
                    columns: [{
                        ...
                        {
                            data: 'vehicle-type-delete',
                            name: 'vehicle-type-delete',
                            orderable: false,
                            searchable: false
                        }
