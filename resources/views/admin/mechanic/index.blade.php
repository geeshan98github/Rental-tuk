        ...
        <div class="subheader">
            ...
            <div class="row" style="margin-left:auto; margin-right:auto; gap: 12px">
                @can('mechanic-applicant-list')
                    <a href=" {{ route('mechanic-applicant-list') }}">
                        ...
                        <div class="panel-content">
                            ...
                            <div class="widget-body no-padding">
                                <div class="table-responsive">
                                    <table class="table table-bordered" style="width:100% ;  border-style: hidden">
                                        <tbody style=" border-style: hidden">
                                            ...
                                            <tr style="border-style: hidden">
                                                <td style="border-style: hidden">NIC </td>
                                                <td style="border-style: hidden">
                                                    <a href="{{ asset('storage/app/private/' . $data->nic_image) }}"
                                                        target="_blank">
                                                        <img src="{{ asset('storage/app/private/' . $data->nic_image) }}"
                                ...
                                @can('send-approvel-mechanic-applicant')
                                    <div class="col-12">
                                        <form action="{{ route('send-mechanic-approvel') }}" method="POST">
                                            @csrf
                                            <div
                                                class="flex-row panel-content border-faded border-left-0 border-right-0 border-bottom-0 d-flex">
                                                <input type="hidden" name="id" value="{{ $data->id }}">
                                                <button class="ml-auto btn btn-primary" type="submit">Send to
                                                    Approval</button>
                                            </div>
                                        </form>
                                    </div>
