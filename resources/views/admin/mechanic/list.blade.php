...
@section('title', 'Mechanic Applicant List')
    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-chart-area'></i> Mechanic Applicants <span class='fw-300'></span>
            </h1>
        ...
        $(function() {
            $(document).ready(function() {
                var table = $('#dt-basic-example').dataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ route('mechanic-applicant-list') }}", // or '/rooms.list' for testing
                        type: 'GET',
