                                ...
                                <div class="mb-3 col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name" name="name" class="form-control"
                                            value="{{ $user->name }}" data-parsley-required="true" required>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="roles" name="roles" required>
                                            @foreach ($roles as $x => $val)
                                                <option value="{{ $val }}"
                                                    {{ $userRole == $val ? 'selected' : '' }}>{{ $val }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 col-12">
                                    <div class="label">Change Password
                                        <button id="changepwyes" type="button"
                                            class="ml-2 btn btn-sm btn-outline-primary"> Yes </button>
                                        <button id="changepwno" type="button"
                                            class="ml-2 btn btn-sm btn-outline-primary"> No </button>
                                    </div>
                                </div>
