    ...
    <div class="card mb-g">
        <div class="card-body">
            <h3 class="fw-500 m-0">
                Plugin licenses
                <small class="m-0">
                    Use of an item is bound by the license you purchase. A license grants you a non-exclusive and non-transferable right to use and incorporate the item in your personal or commercial projects. All third party plugins used in SmartAdmin Laravel are MIT or Customized license (license catered for redistrubtion with this theme). Please check the <a href="#">documentation page</a> under plugins section for details about each plugin.
                </small>
            </h3>
        </div>
    </div>
    ...
    <div class="card mb-g">
        <div class="card-body">
            <h3 class="fw-500 m-0">
                Other licenses
                <small class="m-0">
                    There are other products that uses custom license structure, these products are binded to SmartAdmin brand, and the licenses are applied based on the licenses you own for SmartAdmin Laravel. These products are (but not limited to): Fontawesome 5 Pro, Light Gallery, AltEditor, and SmartPanels.
                </small>
            </h3>
        </div>
    </div>
