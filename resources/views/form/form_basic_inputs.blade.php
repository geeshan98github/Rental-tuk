...
@section('title', 'Basic Inputs - Form Stuff')

@section('content')
<main id="js-page-content" role="main" class="page-content">

    @component('common-components.breadcrumb')
        @slot('item1') Form Stuff @endslot
        @slot('item2') Basic Inputs @endslot
    @endcomponent
                            ...
                            <div class="form-group mb-0">
                                <div class="row">
                                    ...
                                    <div class="col-6 text-right">
                                        <a href="#" title="Responsive Grid" target="_blank">Check out how it works</a>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-3">
