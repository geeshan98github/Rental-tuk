...
@section('title', 'Cropper - Form Plugins')

@section('headerStyle')
<link rel="stylesheet" media="screen, print" href="{{ URL::asset('css/formplugins/cropperjs/cropper.css') }}">
                            ...
                            <div class="row">
                                <div class="col-xl-9">
                                    ...
                                    <div class="img-container">
                                        <img id="image" src="{{ URL::asset('/img/demo/gallery/3.jpg')}}" alt="Picture">
                                    </div>
                                </div>
                                <div class="col-xl-3">
                                    <!-- <h3>Preview:</h3> -->
...
<script src="{{ URL::asset('js/formplugins/cropperjs/cropper.js') }}"></script>
<script>
    $(function() {
        'use strict';
