...
@section('title', 'Select2 - Form Plugins')
            ...
            <div class="d-flex flex-fill">
                <div class="flex-fill">
                    ...
                    <p class="fs-xs text-muted m-0">
                        <strong>IE10 Support:</strong> Since this is the latest version of select2 with a customized UI to match SmartAdmin Laravel, some parts of select2 may have issues with IE10. This is due to the limitation of IE10 CSS & Javascript engine, which is currently outdated and has no workaround method. You may use earlier version of select2 and its vanilla skin if select2 is a must have for your list of plugins.
                    </p>
                </div>
            </div>
        </div>
...
<script src="{{ URL::asset('js/formplugins/select2/select2.bundle.js') }}"></script>
<script>
