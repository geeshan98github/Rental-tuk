...
@section('title', 'Wizard - Form Plugins')

@section('headerStyle')
<link rel="stylesheet" media="screen, print" href="{{ URL::asset('css/formplugins/smartwizard/smartwizard.css') }}">
@stop
...
<script src="{{ URL::asset('js/formplugins/smartwizard/smartwizard.js') }}"></script>
<script>
