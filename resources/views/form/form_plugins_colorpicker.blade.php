...
@section('title', 'Color Picker - Form Plugins')

@section('headerStyle')
<link rel="stylesheet" media="screen, print" href="{{ URL::asset('css/formplugins/bootstrap-colorpicker/bootstrap-colorpicker.css') }}">
@stop
...
<main id="js-page-content" role="main" class="page-content">
    ...
    @slot('item2') Color Picker @endslot
    @endcomponent
    <div class="subheader">
...
<script src="{{ URL::asset('js/formplugins/bootstrap-colorpicker/bootstrap-colorpicker.js') }}"></script>
<script>
