...
@section('title', 'Date Picker - Form Plugins')
...
<main id="js-page-content" role="main" class="page-content">
    ...
    @slot('item2') Date Picker @endslot
    @endcomponent
    <div class="subheader">
...
<script src="{{ URL::asset('js/formplugins/bootstrap-datepicker/bootstrap-datepicker.js') }}"></script>
<script>
    // Class definition
