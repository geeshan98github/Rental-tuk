...
@section('title', 'Dropzone - Form Plugins')

@section('headerStyle')
<link rel="stylesheet" media="screen, print" href="{{ URL::asset('css/formplugins/dropzone/dropzone.css') }}">
@stop
...
<script src="{{ URL::asset('js/formplugins/dropzone/dropzone.js') }}"></script>
@stop