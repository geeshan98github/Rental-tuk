...
@section('title', 'Ion.RangeSlider - Form Plugins')

@section('headerStyle')
<link rel="stylesheet" media="screen, print" href="{{ URL::asset('css/formplugins/ion-rangeslider/ion-rangeslider.css') }}">
@stop
...
<main id="js-page-content" role="main" class="page-content">
    ...
    @slot('item2') Ion.RangeSlider @endslot
    @endcomponent
    <div class="subheader">
...
<script src="{{ URL::asset('js/formplugins/ion-rangeslider/ion-rangeslider.js') }}"></script>
<script>
