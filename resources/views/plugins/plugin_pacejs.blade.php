...
@section('title', 'PaceJS - Core Plugins')
                                        ...
                                        <div class="d-flex app-body-demo border-top-0 border-left-0">
                                            ...
                                            <div class="d-flex flex-column flex-1">
                                                ...
                                                <div class="app-container-demo flex-1 p-3">
                                                    <img src="{{ URL::asset('/img/demo/s-1.png')}}" class="w-100" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="col-xl-12">
            <div id="panel-1" class="panel">
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        <div class="panel-tag">
                            SmartAdmin Laravel comes with integrated and customized styles for PaceJS plugin. PaceJS in short, improves usability from an user's point of view
                        </div>
                        <div class="row">
                            <div class="col-xl-12">
