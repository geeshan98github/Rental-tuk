...
@section('title', 'SmartPanels - Core Plugins')
...
<main id="js-page-content" role="main" class="page-content">
    ...
    @slot('item2') SmartPanels @endslot
    @endcomponent
    <div class="subheader">
        ...
        <div class="d-flex flex-start w-100">
            ...
            <div class="d-flex flex-fill">
                <div class="flex-fill">
                    ...
                    <p class="mb-0">
                        This plugin is exclusive and is built in house to compliment SmartAdmin Laravel. The current version of this plugin does not allow to generate dynamic widgets.
                    </p>
                </div>
            </div>
        </div>
                        ...
                        <div class="panel-container show">
                            <div class="panel-content border-faded border-top-0 border-right-0 border-left-0">
                                <div class="panel-tag m-0 rounded-0">
                                    You can place any visual elements to the content area, and have multiple <code>.panel-content</code>. Check out the <a href="/#">general panels</a> page for more examples of what you can add to panel headers and panel footer
                                </div>
                            </div>
