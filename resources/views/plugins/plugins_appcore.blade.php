...
@section('title', 'App.Core - Core Plugins')
                        ...
                        <table class="table table-hover table-bordered m-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="fs-sm">
                                        Push array to <code>body</code> tag. See <a href="#l">saving to database</a> for more details
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td class="fs-sm">
                                        Fetch class names from <code>body</code> and convert them to JSON string. See <a href="#l">saving to database</a> for more details
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                        ...
                        <table class="table table-hover table-bordered m-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="fs-sm">
                                        Push array to <code>body</code> tag. See <a href="#">saving to database</a> for more details
                                    </td>
                                </tr>
                                <tr>
                                    <td>
