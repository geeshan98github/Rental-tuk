...
@section('title', 'i18Next - Core Plugins')
            ...
            <div class="d-flex flex-start w-100">
                ...
                <div class="d-flex flex-fill">
                    <div class="flex-fill">
                        ...
                        <p>I18next is an internationalization-framework written in and for JavaScript. But it's much
                            more than that.
                            i18next goes beyond just providing the standard i18n features such as (plurals, context,
                            interpolation, format). It provides you with a complete solution to localize your product
                            from web to mobile and desktop.</p>
                        <p>
                            There are other variations and versions of this plugin that is a little more advanced. The
                            one we used is a bit ancient and for a purpose of demonstration only.
                        </p>
                        <p class="m-0">
            ...
            <div class="col-xl-12">
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                The plugin file is loaded via our lazyload script mechanism <code>initApp.loadScript("js/my_lovely_script.js",
                                    myFunction);</code>. This way the plugin and the language file is loaded on demand
                                of the user only. This is triggered using the data attributes
                                <code>data-action="lang"</code> <code>data-lang="en"</code>
                            </div>
                            <p>
                ...
                <div id="panel-2" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="panel-tag">
                                The lang files are stored in the <code>src/custom/lang</code> directory. Each language
                                will have its own file and structure looks like below:
                            </div>
...
$.i18n.init({
    ...
    $('[data-i18n]').i18n();
                            ...
                            <div class="frame-wrap">
                            <pre class="prettyprint">
&lt;script src="{{URL::asset('js/app.jquery.bundle.js')}}"&gt;&lt;/script&gt;
&lt;script src="{{URL::asset('js/i18n/i18n.js')}}"&gt;&lt;/script&gt;
</pre>
                            </div>
                        </div>
                    </div>
