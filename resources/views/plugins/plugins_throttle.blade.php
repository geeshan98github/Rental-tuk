...
@section('title', 'throttle - Core Plugins')
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        ...
                        <figure class="figure my-4">
                            <img src="{{ URL::asset('/img/demo/throttle.png')}}" class="figure-img img-fluid rounded" alt="throttle">
                            <figcaption class="figure-caption">Throttled with no_trailing specified as false or unspecified.</figcaption>
                        </figure>
                        <figure class="figure my-4">
                            <img src="{{ URL::asset('/img/demo/throttle-no_trailing.png')}}" class="figure-img img-fluid rounded" alt="throttle-no_trailing">
                        ...
                        <figure class="figure my-4">
                            <img src="{{ URL::asset('/img/demo/debounce.png')}}" class="figure-img img-fluid rounded" alt="debounce">
                            <figcaption class="figure-caption">Debounced with at_begin specified as false or unspecified</figcaption>
                        </figure>
                        <figure class="figure my-4">
                            <img src="{{ URL::asset('/img/demo/debounce-at_begin.png')}}" class="figure-img img-fluid rounded" alt="debounce-no_trailing">
